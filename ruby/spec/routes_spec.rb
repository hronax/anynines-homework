...
describe CommentRoutes do
  ...
  context 'testing the get articles endpoint GET /' do
    ...
    it 'checks response status and body' do
      ...
      expect(hashed_response['comments'].length).to eq(3)
    end
  end

  context 'testing the get single comment endpoint GET /99' do
    let(:response) { get '/99/comments', nil, auth_header }
  ...
  context 'testing the create comment endpoint ' do
    let(:response) do
      post '/3/comments', JSON.generate('title' => 'Route Test Comment', 'content' => 'test content'),
           prepare_headers
    end
  ...
  context 'testing the update article endpoint ' do
    let(:response) do
      put '/3/comments/6', JSON.generate('content' => 'update'),
          prepare_headers
    end
  ...
  context 'testing the delete article endpoint ' do
    let(:response) { delete '/3/comments/6', nil, auth_header }
  ...
  context 'testing the delete article endpoint; wrong id' do
    let(:response) { delete '/3/comments/99', nil, auth_header }
